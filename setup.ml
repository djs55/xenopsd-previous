...
(* OASIS_START *)
(* DO NOT EDIT (digest: f724a933b7eae63d3ba350e4ba492c8f) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("xenswitch", None);
                           FindlibPackage ("xenswitch.unix", None)
                        ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\255\1923\149}\155\149\254\002\205\031&)\224GT";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
